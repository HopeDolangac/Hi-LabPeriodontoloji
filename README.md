...
## 📥 Download
Since the full dataset is currently utilized in ongoing study and contains extensive data that requires further analysis, the complete dataset cannot be made publicly available at this moment. You can download the dataset from the following link:
[Download Hi-LabPeriodontoloji Dataset](https://drive.google.com/drive/folders/16tVP_Zm9yBJvZcbV9gA_lh7sxR6RcRuE?usp=drive_link)
